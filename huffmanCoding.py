...
class HuffmanCoding:
    ...
    def compress(self):
        ...
        with open(self.path, 'r+') as file, open(output_path, 'wb') as output:
            ...
            #construct the heap from freqDict()
            ...
            #create encoded texts using codes
            encoded_text = self.__getEncodedText(text)

            #put this encoded texts into the binary file
...
path = '/Users/surya/Documents/Milestone4/sample.txt.rtf'
